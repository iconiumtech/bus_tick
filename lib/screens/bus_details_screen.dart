  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Stack(
          children: [
            BackWidget(title: Strings.busDetails,),
            bodyWidget(context),
  ...
  buttonWidget(BuildContext context) {
    return Positioned(
      ...
      child: GestureDetector(
        ...
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => SeatPlanScreen(bus:
          widget.bus,)));
        },
      ),
    );
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          MyRating(rating: widget.bus.rating,),
  ...
  _pickupPointWidget(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: Dimensions.heightSize,),
        _pointTitle('Abdullahpur Bus Point', '8:30'),
        _pointTitle('Newyork Bus Stop', '10:30'),
        _pointTitle('New Road City', '07:15'),
      ],
    );
  }
