...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<String> fromCityList = ["Dhaka", "Narayongonj", "Cumilla", "Feni", "Cittagong", 'Cox-Bazzar'];
  List<String> toCityList = ["Dhaka", "Narayongonj", "Cumilla", "Feni", "Cittagong", 'Cox-Bazzar'];
