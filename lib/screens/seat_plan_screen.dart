...
class _SeatPlanScreenState extends State<SeatPlanScreen> {
  ...
  List<dynamic> pickupPointList = ['Abdullahpur Bus Point (8:30)', 'Newyork Bus Stop (10:30)', 'N'
      'ew Road City (07:15)'];
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Stack(
          children: [
            BackWidget(title: Strings.seatPlan,),
            bodyWidget(context),
  ...
  buttonWidget(BuildContext context) {
    return Positioned(
      ...
      child: GestureDetector(
        ...
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => PaymentScreen(bus:
          widget.bus)));
        },
      ),
    );
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    _seatHintWidget('assets/svg/seat_white.svg',Strings.available),
                    _seatHintWidget('assets/svg/seat_green.svg',Strings.selected),
                  ],
                ),
              ),
              Align(
            ...
            child: FlatButton(
              ...
              onPressed: () {
                ...
                if (!slot.isAvailable) {
                  ...
                  Fluttertoast.showToast(msg: Strings.ticketIsNotAvailable,
